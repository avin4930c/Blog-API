    ...
    return (
        <section>
            <div className="m-auto max-w-[90%]">
                <h1 className="text-5xl py-4 text-center w-3/4 max-lg:w-full m-auto">Special Pork Meat review</h1>
                <p className="font-thin text-center"><span className="font-semibold">Food</span> - 2min read - 17 July 2024</p>
                <div className="font-medium text-center py-2">Author: Luffy</div>
                <div>
                    <img className="xl:max-h-[400px] sm:max-h-[300px] object-contain" src="https://i.pinimg.com/originals/19/80/bb/1980bb1a761ce60f9709def1173956d6.jpg" alt="" />
                </div>
